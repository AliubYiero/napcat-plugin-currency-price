...
3. **[config-pattern.md](./config-pattern.md)** 与 **[instruction-pattern.md](./instruction-pattern.md)** — 两大高频链路: 配置与指令。
4. **[message-send-pattern.md](./message-send-pattern.md)** 与 **[help-output-pattern.md](./help-output-pattern.md)** — 横切能力, 写 handler 时随用随查。
